...
export default class usersverify extends Component {
  render() {
    return (
      ...
      <div>
         ...
         <div style={{ width: '100', marginRight: 50 }}>
          ...
          <label style={{ fontFamily: 'plus Jakarta sans', color: "#64748B", fontSize: '16px', fontWeight: '400', lineHeight: '24px', display: "flex", marginTop: 9 }}>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Arcu dictum aliquam nisl maecenas mattis molestie velit.</label>
          ...
          <label style={{ fontFamily: 'plus Jakarta sans', color: "#64748B", fontSize: '16px', fontWeight: '400', lineHeight: '24px', display: "flex", marginTop: 9 }}>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quam ultrices ultrices aliquet elementum. Enim aliquam quam adipiscing scelerisque aenean.<br>
          </br> Egestas orci eu orci sed. Rutrum faucibus eu et, accumsan magna amet commodo. Amet libero libero aliquam sapien ut facilisi lacinia nibh nunc. Magna leo<br>
          </br> pulvinar diam ut sed arcu semper pharetra. Erat pellentesque sed est tempus senectus et.</label>
          ...
          <div style={{ display: "flex", flexDirection: "row" }}>
            <img style={{ width: "65px", height: '65px', marginTop: 40 }} src={require('../../../assets/Ellipse 33.png')} alt='' />
          ...
          <label style={{ fontFamily: 'plus Jakarta sans', color: "#64748B", fontSize: '16px', fontWeight: '400', lineHeight: '24px', display: "flex", marginTop: 29 }}>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quam ultrices ultrices aliquet elementum. Enim aliquam quam adipiscing scelerisque aenean.<br>
          </br> Egestas orci eu orci sed. Rutrum faucibus eu et, accumsan magna amet commodo. Amet libero libero aliquam sapien ut facilisi lacinia nibh nunc. Magna leo<br>
          </br> pulvinar diam ut sed arcu semper pharetra. Erat pellentesque sed est tempus senectus et.</label>
