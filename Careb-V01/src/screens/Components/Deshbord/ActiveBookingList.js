                    ...
                    <td>
                      <Popup shouldCloseOnOverlayClick={false} closeOnDocumentClick={false}
                        ...
                        <div style={{
                                ...
                                <div style={{
                                  ...
                                  <div className='content' style={{justifyContent: 'center', display: 'flow'}}>
                                    <div style={{textAlign: 'center'}}>
                                      ...
                                      <p style={{color: '#64748B'}}>Get exclusive updates and gifts right at your
                                        desktop without opening your mail again and again! You can disable them
                                        anytime.</p>
                                    </div>
                                    <div>
                                      <label style={{color: '#0F172A', fontSize: 20, fontWeight: '500'}}>Explain
                                        Reason</label>
                                      <textarea
                                          style={{
                                            border: '1px solid',
                          ...
                          <Popup shouldCloseOnOverlayClick={true} closeOnDocumentClick={false} contentStyle={{
                            width: "25%",
                            height: '45%',
                            alignItems: 'center',
                            display: 'flex',
                            ...
                            {(close) => (
                                <div style={{
                                  ...
                                  <div className='content' style={{
                                    ...
                                    <Popup disabled={false} closeOnDocumentClick={false} data-backdrop="static"
                                           shouldCloseOnOverlayClick={false} data-keyboard="false" trigger={<button
                                        style={{
                                          ...
                                          height: 40,
                                          borderRadius: 5
                                        }} onClick={() => close()}>Upgrade Order</button>} modal contentStyle={{
                                      width: '20%',
                                      height: '70%',
                                      display: 'flex',
                                      borderRadius: 5,
