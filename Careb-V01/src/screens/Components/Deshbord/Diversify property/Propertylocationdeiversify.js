  ...
  render() {
    return (
      <div className='main-section' style={{ width: '90%', padding: 20 }}>
        <label style={{ fontSize: 17, fontWeight: '500', marginLeft: 20 }}>Step 2/4</label>
        <h4 style={{ fontSize: 25, fontWeight: '700', marginLeft: 20 }}>Diversify Property Located</h4>
        ...
        <div style={{ display: 'flex', marginTop: 30, width: '92%', alignItems: 'center', justifyContent: 'flex-end' }}>
          <button className='back-btn'
            ...
            onClick={() =>
              this.props.NextCallBack({ navigationTo: 'property_Location', id: 1, currentid: 6, bt_type: 'Back' })
            }
          >
            Back
          </button>
          <button className='next-btn'
            ...
            onClick={() => {
              ...
              this.props.NextCallBack({ navigationTo: 'property_Images', id: 3, bt_type: 'Next' });
            }} >
            Next
          </button>
        </div>
