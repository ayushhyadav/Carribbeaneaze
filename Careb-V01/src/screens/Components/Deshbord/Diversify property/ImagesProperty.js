  ...
  render() {
    return (
      <div className='main-section' style={{ width: '70%', padding: 20 }}>
        ...
        <h4 style={{ fontSize: 25, fontWeight: '700', marginLeft: 20 }}>Diversify Information</h4>
        ...
        <div style={{ display: 'flex', marginTop: 30, width: '92%', alignItems: 'center', justifyContent: 'flex-end' }}>
          <button className='back-btn'
            ...
            onClick={() => this.props.NextCallBack({ navigationTo: 'property_Images', id: 2, currentid: 7, bt_type: 'Back' })}
          >
            Back
          </button>
          <button className='next-btn'
            ...
            onClick={() => {
              ...
              this.props.NextCallBack({ navigationTo: 'Extra_Service', id: 4, bt_type: 'Next' });
            }}
          >
            Next
          </button>
